    ...
    <div className="signup_container px-2 py-5">
      <div className="container mx-auto">
        <div className="flex justify-center items-center ">
          <div className="flex justify-center items-center bg-white rounded-md lg:w-9/12 xl:w-9/12">
            {/* left side image */}
            ...
            <div className="w-full lg:w-6/12 xl:w-6/12 flex flex-col items-center">
              ...
              >
                ...
                <div className="w-full py-2">
                  <button className=" border border-gray-200 py-3 flex justify-center w-full text-1xl hover:bg-gray-300 text-gray-400 items-center">
                ...
                <p className="text-base  text-center py-2">
                  ...
                  <span className="font-medium primary_clr">SIGN IN</span>
                </p>
                {/* info and icon */}
